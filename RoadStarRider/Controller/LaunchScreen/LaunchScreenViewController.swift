...
//        let mainNav = UIStoryboard.AppStoryboard.Main.instance.instantiateViewController(withIdentifier: UINavigationController.Identifiers.MainNav) as! UINavigationController
//        UIApplication.shared.keyWindow!.replaceRootViewControllerWith(mainNav, animated: true, completion: nil)
    }
}
